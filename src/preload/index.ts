...
const api: AiQuoteApi = {
  ...
  aiModelNames: invoke('ai:modelNames'),
  ...
  estimateNormsBatchCreate: invoke('estimate:norms:batchCreate'),
  estimateNormsSuggestFromCompleted: invoke('estimate:norms:suggestFromCompleted'),
