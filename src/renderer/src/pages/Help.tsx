...
const TOPICS: HelpTopic[] = [
  ...
  },
  {
    key: 'suppliers',
    title: '4. 供应商',
    keywords: '供应商 联系人 批量 导出',
    body: (
      <Paragraph style={P}>
        管理供应商（名称 / 联系人 / 备注）。价格记录、AI 报价单导入均可关联供应商。支持关键词筛选、多选批量删除、导出选中为 Excel。
      </Paragraph>
    )
  },
  {
  ...
  },
  {
    key: 'templates',
    title: '13. 项目模板',
    keywords: '项目模板 类型模板 空间置底 骨架 板块空间',
    body: (
      <>
        <Paragraph style={P}>
  ...
  },
  {
    key: 'exporttemplates',
    title: '14. 导出模板',
    keywords: '导出模板 版本集 ai 识别 客户 xlsx 出厂模板 标准三版本',
    body: (
      <>
        <Paragraph style={P}>
  ...
  },
  {
    key: 'drawing',
    title: '15. 图纸识别',
    keywords: '图纸识别 图片 pdf 视觉 图片处理用途绑定 两入口',
    body: (
      <>
        <Paragraph style={P}>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Paragraph style={P}>
          <Text strong>Q：数据存在哪里？</Text> 本地单文件数据库，建议定期手动备份。
        </Paragraph>
      </>
    )
  }
