...
import { Form, Select, InputNumber, Input, Button, message, Card, Typography, Space, Switch, Tooltip, Radio, Progress, Alert, Tag, Table, Modal, Popconfirm } from 'antd';
...
export default function Settings(): React.JSX.Element {
  ...
  const openAddProfileModal = (): void => {
    ...
    profileForm.setFieldsValue({ protocol: 'openai', name: '', baseUrl: '', apiKey: '', model: '' });
  ...
  return (
    <div>
      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        <Card title="计价设置" style={{ maxWidth: 480 }} loading={loading}>
        ...
        <Card title="AI 配置档案" style={{ maxWidth: 720 }} loading={aiLoading}>
          <Typography.Paragraph type="secondary">
            支持配置多个厂家/账号的 AI 接口档案，分别用于「文本识别」（报价单导入识别、导出模板解析）、
            「图片处理」（图纸识别）、「定时查价」三种用途，可自由绑定，也可共用同一档案。支持任意 OpenAI
            兼容接口或 Anthropic 接口，填入自有 API Key 即可，密钥仅保存在本机数据库中。常见示例：
          ...
          <Typography.Paragraph type="secondary" style={{ marginTop: -12 }}>
            ...
            <Typography.Text code>deepseek-chat</Typography.Text>
            <br />
            ...
            <Typography.Text code>claude-3-5-sonnet-20241022</Typography.Text>
          </Typography.Paragraph>
          ...
          <Table<AiProfile>
            ...
            locale={{ emptyText: '尚未配置任何 AI 档案，点击下方「新增档案」开始配置' }}
            columns={[
          ...
          />
          <Button icon={<PlusOutlined />} onClick={openAddProfileModal} style={{ marginBottom: 20 }}>
            新增档案
          </Button>
        ...
        <Card title="查价监控配置" style={{ maxWidth: 560 }} loading={watchLoading}>
        ...
        <Card title="软件更新" style={{ maxWidth: 560 }}>
